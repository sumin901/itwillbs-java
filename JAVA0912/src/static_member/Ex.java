...
//		System.out.println("NormalMember.a : " + NormalMember.a);
		...
		// => 인스턴스가 생성되기 전이지만 이미 메모리에 로딩되어있으므로
		...
		StaticMember.a = 500; // => java에서 요구하는 이상적인 형태
//		StaticMember.b = 500; // 컴파일 에러 발생! 클래스명만으로는 접근 불가!
		System.out.printf("s1.a : %d, s2.a : %d \n", s1.a, s2.a);
...
class StaticMember{
	static int a = 10; // 클래스 멤버변수(=static 멤버변수 =정적 멤버변수)
	int b = 20; // 인스턴스 멤버변수
}
